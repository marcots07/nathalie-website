...
export default function Experience({ dict }: { dict: Dictionary }) {
  return (
    <section id="experience" className="relative py-24 md:py-36 bg-cream-100/40">
    ...
    >
      ...
      <div className={`pl-12 md:pl-0 ${isEven ? "md:col-start-1 md:text-right md:pr-8" : "md:col-start-2 md:pl-8"}`}>
        <div className="flex items-center gap-3 mb-2 flex-wrap">
          ...
          {isCurrent && (
            <span className="text-xs uppercase tracking-[0.2em] text-terracotta-500 font-medium">
              {currentLabel}
            </span>
          )}
        </div>
